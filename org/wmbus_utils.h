...
bool decrypt_ELL_AES_CTR(vector<uchar> &frame, vector<uchar>::iterator &pos, vector<uchar> &aeskey);
bool decrypt_TPL_AES_CBC_IV(vector<uchar> &frame, vector<uchar>::iterator &pos, vector<uchar> &aeskey,
